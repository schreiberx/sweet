...
subprocess.call('scons --program=swe_rexi --plane-spectral-space=enable --mode=release --threading=omp --gui=enable --parareal=none --plane-spectral-dealiasing=disable '.split(' '), shell=False)
