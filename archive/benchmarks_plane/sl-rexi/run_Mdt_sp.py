...
#subprocess.call('scons --program=swe_rexi --plane-spectral-space=enable --mode=release --threading=off --gui=enable --rexi-parallel-sum=enable '.split(' '), shell=False)

subprocess.call('scons --program=swe_rexi --plane-spectral-space=enable --mode=release --threading=omp --gui=enable --rexi-parallel-sum=enable '.split(' '), shell=False)
