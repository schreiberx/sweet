...
execs = [
	# swe
	['swe',
		'scons --compiler='+compiler+' --gui=disable --compile-program=swe --plane-spectral-space=disable',
	...
	['swe_spectral',
		'scons --compiler='+compiler+' --gui=disable --compile-program=swe --plane-spectral-space=enable',
	...
	# staggered grid
	['swe_staggerred',
		'scons --compiler='+compiler+' --gui=disable --compile-program=swe_staggered --plane-spectral-space=disable',
