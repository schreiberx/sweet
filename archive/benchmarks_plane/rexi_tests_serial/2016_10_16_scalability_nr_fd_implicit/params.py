...
comp_spec='scons --compiler=gnu --sweet-mpi=disable --program=swe_rexi --plane-spectral-space=enable --libfft=enable --plane-spectral-dealiasing=disable --mode=release'
comp_cart='scons --compiler=gnu --sweet-mpi=disable --program=swe_rexi --plane-spectral-space=disable --libfft=enable --plane-spectral-dealiasing=disable --mode=release'

comp_rexi='scons --compiler=gnu --sweet-mpi=disable --program=swe_rexi --plane-spectral-space=disable --libfft=enable --rexi-parallel-sum=disable --plane-spectral-dealiasing=disable --mode=release'
comp_rexi_par='scons --compiler=gnu --sweet-mpi=disable --program=swe_rexi --plane-spectral-space=disable --libfft=enable --rexi-parallel-sum=enable --plane-spectral-dealiasing=disable --mode=release'
...
#		[	'nr_fd_cart_cgrid',	' -S 0 --timestepping-mode 0 --staggering 1 -C '+str(cfl), 	'Finite differences in Cartesian space, C-grid',	comp_cart, 'nr_fd_cart_cgrid'	],
		...
		[	'nr_fd_implicit_cart_cgrid',	' -S 0 --timestepping-mode 3 --staggering 1 -C '+str(cfl), 	'Finite differences with implicit time stepping in Cartesian space, C-grid',	comp_cart, 'nr_fd_cart_cgrid'	],
