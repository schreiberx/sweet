...
public:
	...
	)
	{
		...
		sweet::SphereData_SpectralComplex phi0 = sweet::Convert_SphereDataSpectral_To_SphereDataSpectralComplex::physical_convert(i_phi0);
		sweet::SphereData_SpectralComplex vrt0 = sweet::Convert_SphereDataSpectral_To_SphereDataSpectralComplex::physical_convert(i_vrt0);
		sweet::SphereData_SpectralComplex div0 = sweet::Convert_SphereDataSpectral_To_SphereDataSpectralComplex::physical_convert(i_div0);
		...
		o_phi = sweet::Convert_SphereDataSpectralComplex_To_SphereDataSpectral::physical_convert_real(phi1);
		o_vort = sweet::Convert_SphereDataSpectralComplex_To_SphereDataSpectral::physical_convert_real(vrt1);
		o_div = sweet::Convert_SphereDataSpectralComplex_To_SphereDataSpectral::physical_convert_real(div1);
	}
	...
	bool setup_vectorinvariant_progphivortdiv(
			const sweet::SphereData_Config *i_sphereDataConfigSolver,
