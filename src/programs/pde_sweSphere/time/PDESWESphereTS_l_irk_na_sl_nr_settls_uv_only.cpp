...
bool PDESWESphereTS_l_irk_na_sl_nr_settls_uv_only::implements_timestepping_method(const std::string &i_timestepping_method
									)
{
...
std::string PDESWESphereTS_l_irk_na_sl_nr_settls_uv_only::string_id()
{
	return "l_irk_na_sl_nr_settls_uv_only";
}


void PDESWESphereTS_l_irk_na_sl_nr_settls_uv_only::setup_auto()
{
	setup(
		timestepping_order
	);
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_uv_only::run_timestep(
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_uv_only::setup(
...
)
{
	...
	swe_sphere_ts_l_irk->setup(1, 0.5 * shackDict.timecontrol.current_timestep_size, shackDict.disc.timestepping_crank_nicolson_filter, false);
}
