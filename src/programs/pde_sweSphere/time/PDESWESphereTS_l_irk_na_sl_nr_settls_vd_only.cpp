...
bool PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::implementsTimesteppingMethod(const std::string &i_timestepping_method)
{
...
std::string PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::getIDString()
{
	return "l_irk_na_sl_nr_settls_vd_only";
}


bool PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::setup_auto(
...
bool PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::setup_main(
		sweet::SphereOperators *io_ops,
...
)
{
	...
	swe_sphere_ts_ln_erk_split_vd__l_erk_1st_order.setup_main(
			ops,
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::runTimestep(
