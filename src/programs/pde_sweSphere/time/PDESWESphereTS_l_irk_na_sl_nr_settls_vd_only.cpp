...
#include "PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only.hpp"



bool PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::implements_timestepping_method(const std::string &i_timestepping_method
									)
{
...
std::string PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::string_id()
{
	return "l_irk_na_sl_nr_settls_vd_only";
}


void PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::setup_auto()
{
	setup(
		timestepping_order
	);
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::run_timestep(
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::run_timestep_2nd_order(
...
void PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::setup(
...
)
{
	...
	swe_sphere_ts_ln_erk_split_vd__l_erk_1st_order = new PDESWESphereTS_ln_erk_split_vd(shackDict, ops);
...
PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only::PDESWESphereTS_l_irk_na_sl_nr_settls_vd_only(
