...
public:
	 ...
	 */
	sweet::SphereData_Spectral apply(
			const sweet::SphereData_Spectral &i_x	///< solution to be searched
	)
	{
		sweet::SphereData_Spectral out(sphereDataConfig);
	...
	sweet::SphereData_Spectral solve(
