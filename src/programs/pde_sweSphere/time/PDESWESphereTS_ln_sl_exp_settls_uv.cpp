...
bool PDESWESphereTS_ln_sl_exp_settls_uv::implements_timestepping_method(const std::string &i_timestepping_method
									)
{
	/*
...
std::string PDESWESphereTS_ln_sl_exp_settls_uv::string_id()
{
	return string_id_storage;
}


void PDESWESphereTS_ln_sl_exp_settls_uv::run_timestep(
...
void PDESWESphereTS_ln_sl_exp_settls_uv::setup_auto()
{
	PDESWESphereTS_ln_sl_exp_settls_uv::LinearCoriolisTreatment_enum linear_coriolis_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_IGNORE;
	PDESWESphereTS_ln_sl_exp_settls_uv::NLRemainderTreatment_enum nonlinear_remainder_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::NL_REMAINDER_IGNORE;
	...
	if (timestepping_method.find("l_exp") != std::string::npos)
		linear_coriolis_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_LINEAR;
	else if (timestepping_method.find("lc_na_sl") != std::string::npos)
		linear_coriolis_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_SEMILAGRANGIAN;
	else if (timestepping_method.find("lc_") != std::string::npos)
		linear_coriolis_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_NONLINEAR;


	// Search for nonlinear remainder term
	if (timestepping_method.find("_nr_") != std::string::npos)
		nonlinear_remainder_treatment = PDESWESphereTS_ln_sl_exp_settls_uv::NL_REMAINDER_NONLINEAR;
	...
	if (linear_coriolis_treatment == PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_LINEAR)
		string_id_storage += "l";
	else
	...
	if (linear_coriolis_treatment == PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_SEMILAGRANGIAN)
	...
	if (linear_coriolis_treatment == PDESWESphereTS_ln_sl_exp_settls_uv::CORIOLIS_NONLINEAR)
		string_id_storage += "_lc";

	if (nonlinear_remainder_treatment == PDESWESphereTS_ln_sl_exp_settls_uv::NL_REMAINDER_NONLINEAR)
...
void PDESWESphereTS_ln_sl_exp_settls_uv::print_help()
{
...
void PDESWESphereTS_ln_sl_exp_settls_uv::setup(
...
)
{
	...
	swe_sphere_ts_l_rexi = new PDESWESphereTS_l_exp(shackDict, ops);
