...
class PDESWESphereTS_ln_sl_exp_settls_vd	: public PDESWESphereTS_BaseInterface
{
public:
...
public:
	PDESWESphereTS_ln_sl_exp_settls_vd();
	...
	virtual ~PDESWESphereTS_ln_sl_exp_settls_vd();
};
