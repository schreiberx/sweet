...
bool PDESWESphereTS_l_irk_na_erk_vd::implements_timestepping_method(const std::string &i_timestepping_method
									)
{
...
void PDESWESphereTS_l_irk_na_erk_vd::setup_auto()
{
	if (
...
std::string PDESWESphereTS_l_irk_na_erk_vd::string_id()
{
...
void PDESWESphereTS_l_irk_na_erk_vd::run_timestep(
 ...
 * Setup
 */
void PDESWESphereTS_l_irk_na_erk_vd::setup(
...
PDESWESphereTS_l_irk_na_erk_vd::PDESWESphereTS_l_irk_na_erk_vd(
		...
		timestepping_na_erk_split_vd(shackDict, op),
		version_id(0),
