...
bool PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::implements_timestepping_method(const std::string &i_timestepping_method
									)
{
#if 0
	/*
...
std::string PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::string_id()
{
	return "lg_exp_na_sl_lc_nr_etd_uv";
}


void PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::setup_auto()
{
...
void PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::print_help()
{
...
void PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::run_timestep(
 ...
 * Setup
 */
void PDESWESphereTS_lg_exp_na_sl_lc_nr_etd_uv::setup(
...
#if 0
		,
		ts_ups0_exp(shackDict, ops),
		ts_ups1_exp(shackDict, ops),
		ts_ups2_exp(shackDict, ops),
		ts_ups3_exp(shackDict, ops)
#endif
{
}
