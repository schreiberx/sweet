#ifndef SRC_PROGRAMS_SIMDATA_TIMESTEPPERPDETERM_NR_UV_HPP_
#define SRC_PROGRAMS_SIMDATA_TIMESTEPPERPDETERM_NR_UV_HPP_
...
class PDESWESphere_nr_uv	:
	public sweet::DESolver_TimeTreeNode_NodeLeafHelper<PDESWESphere_nr_uv>,
...
public:
	...
	~PDESWESphere_nr_uv();
	PDESWESphere_nr_uv(
			const PDESWESphere_nr_uv &i_val
	);
