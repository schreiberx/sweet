...
#ifndef SRC_PROGRAMS_SWE_PLANE_SWE_PLANE_TS_LN_ERK_HPP_
#define SRC_PROGRAMS_SWE_PLANE_SWE_PLANE_TS_LN_ERK_HPP_
...
#endif /* SRC_PROGRAMS_SWE_PLANE_SWE_PLANE_TS_LN_ERK_HPP_ */
