...
void SWE_Sphere_TS_lg_rexi_lf_n_etdrk::run_timestep(
 ...
 * Setup
 */
void SWE_Sphere_TS_lg_rexi_lf_n_etdrk::setup(
...
SWE_Sphere_TS_lg_rexi_lf_n_etdrk::SWE_Sphere_TS_lg_rexi_lf_n_etdrk(
