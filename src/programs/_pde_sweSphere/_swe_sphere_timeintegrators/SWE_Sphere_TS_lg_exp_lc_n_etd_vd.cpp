...
std::string SWE_Sphere_TS_lg_exp_lc_n_etd_vd::string_id()
{
	return "lg_exp_lc_n_etd";
}


void SWE_Sphere_TS_lg_exp_lc_n_etd_vd::setup_auto()
{
...
void SWE_Sphere_TS_lg_exp_lc_n_etd_vd::print_help()
{
...
void SWE_Sphere_TS_lg_exp_lc_n_etd_vd::run_timestep(
 ...
 * Setup
 */
void SWE_Sphere_TS_lg_exp_lc_n_etd_vd::setup(
...
SWE_Sphere_TS_lg_exp_lc_n_etd_vd::SWE_Sphere_TS_lg_exp_lc_n_etd_vd(
