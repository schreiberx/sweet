...
)
{
	...
	if (rexiSimVars->exp_method == "direct")
	{
		...
		if (timestepping_method_l_exp_direct_special == nullptr)
			timestepping_method_l_exp_direct_special = new SWE_Sphere_TS_l_exp_direct_special(shackDict, ops);
	...
	else if (rexiSimVars->exp_method == "ss_taylor")
	{
		...
		if (timestepping_method_lg_exp_lc_exp == nullptr)
			timestepping_method_lg_exp_lc_exp = new SWE_Sphere_TS_lg_exp_lc_taylor(shackDict, ops);
