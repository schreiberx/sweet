...
void SWE_Sphere_TS_l_irk_na_sl_nr_settls_uv_only::run_timestep(
...
)
{
	...
	swe_sphere_ts_ln_erk_split_uv__l_erk_1st_order = new SWE_Sphere_TS_ln_erk_split_uv(shackDict, ops);
	...
	swe_sphere_ts_l_irk = new SWE_Sphere_TS_l_irk(shackDict, ops);
