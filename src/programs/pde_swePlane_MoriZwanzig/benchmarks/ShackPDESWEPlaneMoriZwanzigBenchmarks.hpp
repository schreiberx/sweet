...
#ifndef SRC_INCLUDE_SWEET_SHACK_PDE_SWE_PLANE_MORI_ZWANZIG_BENCHMARKS_HPP_
#define SRC_INCLUDE_SWEET_SHACK_PDE_SWE_PLANE_MORI_ZWANZIG_BENCHMARKS_HPP_
 ...
 */
class ShackPDESWEPlaneMoriZwanzigBenchmarks	:
...
public:
	...
	void (*getExternalForcesCallback)(int, double, sweet::PlaneData_Spectral*, ShackPDESWEPlaneMoriZwanzigBenchmarks*) = nullptr;// = &fun_no_forces;		/// SET TO NULLPTR
	ShackPDESWEPlaneMoriZwanzigBenchmarks *getExternalForcesUserData = nullptr;
