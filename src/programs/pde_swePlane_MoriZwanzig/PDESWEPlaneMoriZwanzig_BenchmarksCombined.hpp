...
#ifndef SRC_INCLUDE_BENCHMARKS_SWE_PLANE_MORI_ZWANZIG_COMBINED_HPP
#define SRC_INCLUDE_BENCHMARKS_SWE_PLANE_MORI_ZWANZIG_COMBINED_HPP
...
public:
	...
	)
	{
		...
		if (shackPDESWEPlaneBenchmarks->benchmark_name == "gaussian_bump" || shackPDESWEPlaneBenchmarks->benchmark_name == "gaussian_bump_phi_pint")
		{
			PDESWEPlaneMoriZwanzigBench_GaussianBump swe_gaussian_bump;
		...
		else if (shackPDESWEPlaneBenchmarks->benchmark_name == "gaussian_bump_advection")
		{
			...
			auto callback_external_forces_advection_field =
					[](
							...
							ShackPDESWEPlaneMoriZwanzigBenchmarks* i_shackBenchmark		/// user data (pointer to this class)
			)
			{
