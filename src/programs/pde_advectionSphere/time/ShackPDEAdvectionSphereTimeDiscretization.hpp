...
#ifndef SRC_INCLUDE_SWEET_SHACK_TIME_PDE_ADVECTION_SPHERE_DISCRETIZATION_HPP_
#define SRC_INCLUDE_SWEET_SHACK_TIME_PDE_ADVECTION_SPHERE_DISCRETIZATION_HPP_
...
class ShackPDEAdvectionSphereTimeDiscretization	:
