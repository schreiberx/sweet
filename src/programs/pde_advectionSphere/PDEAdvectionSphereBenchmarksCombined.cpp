...
{
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_zero));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_nair_lauritzen_sl));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_advection_vector_uv_velocities));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_advection_vector_uv_gauss_bumps));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_advection_vector_3d_normal_vectors));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_williamson_1_advection_cos_bell));
	_registered_benchmarks.push_back(static_cast<PDEAdvectionSphereBenchmarks_BaseInterface*>(new PDEAdvectionSphereBenchmark_williamson_1_advection_gauss_bump));
...
bool PDEAdvectionSphereBenchmarksCombined::setup_3_benchmarkDetection()
{
	...
	for (std::size_t i = 0; i < _registered_benchmarks.size(); i++)
	{
		PDEAdvectionSphereBenchmarks_BaseInterface *ts = _registered_benchmarks[i];
...
void PDEAdvectionSphereBenchmarksCombined::_benchmarksFreeAll(
		PDEAdvectionSphereBenchmarks_BaseInterface *skip_this
)
{
	for (std::size_t i = 0; i < _registered_benchmarks.size(); i++)
	{
