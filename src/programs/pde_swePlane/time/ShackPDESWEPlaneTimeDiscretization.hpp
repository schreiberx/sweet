...
#ifndef SRC_INCLUDE_SWEET_SHACK_PDE_SWE_PLANE_TIME_DISCRETIZATION_HPP_
#define SRC_INCLUDE_SWEET_SHACK_PDE_SWE_PLANE_TIME_DISCRETIZATION_HPP_
...
class ShackPDESWEPlaneTimeDiscretization	:
