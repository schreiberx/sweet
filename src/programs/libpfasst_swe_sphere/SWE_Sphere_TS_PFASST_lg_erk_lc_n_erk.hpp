...
#ifndef SRC_PROGRAMS_SWE_SPHERE_REXI_SWE_SPHERE_TS_PFASST_LG_ERK_LC_N_ERK_HPP_
#define SRC_PROGRAMS_SWE_SPHERE_REXI_SWE_SPHERE_TS_PFASST_LG_ERK_LC_N_ERK_HPP_
...
class SWE_Sphere_TS_PFASST_lg_erk_lc_n_erk	: public SWE_Sphere_TS_PFASST_interface
{
...
public:
	SWE_Sphere_TS_PFASST_lg_erk_lc_n_erk(
	...
	virtual ~SWE_Sphere_TS_PFASST_lg_erk_lc_n_erk();
};
