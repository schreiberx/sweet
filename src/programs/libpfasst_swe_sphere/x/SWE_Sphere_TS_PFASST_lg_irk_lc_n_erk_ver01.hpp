...
class SWE_Sphere_TS_PFASST_lg_irk_lc_n_erk	: public SWE_Sphere_TS_PFASST_interface
{
	 ...
	 */
	SWE_Sphere_TS_PFASST_lg_irk timestepping_lg_irk;
	SWE_Sphere_TS_PFASST_lg_cn timestepping_lg_cn;

	/*
	 * Non-linear time steppers
	 */
	SWE_Sphere_TS_PFASST_lg_erk_lc_n_erk timestepping_lg_erk_lc_n_erk;

	SphereTimestepping_ExplicitRK timestepping_rk_nonlinear;


public:
	SWE_Sphere_TS_PFASST_lg_irk_lc_n_erk(
	...
	virtual ~SWE_Sphere_TS_PFASST_lg_irk_lc_n_erk();
};
