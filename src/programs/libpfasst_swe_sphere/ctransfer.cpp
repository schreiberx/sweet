...
extern "C"
{
  void c_sweet_data_restrict(
			     ...
			     double i_t) 
  {
    const SphereData& phi_Y_fine  = i_Y_fine->get_phi();
    const SphereData& vort_Y_fine = i_Y_fine->get_vort();
    const SphereData& div_Y_fine  = i_Y_fine->get_div();

    SphereData& phi_Y_coarse  = io_Y_coarse->get_phi();
    SphereData& vort_Y_coarse = io_Y_coarse->get_vort();
    SphereData& div_Y_coarse  = io_Y_coarse->get_div();
  ...
  void c_sweet_data_interpolate(
				...
				double i_t) 
  {
    const SphereData& phi_Y_coarse  = i_Y_coarse->get_phi();
    const SphereData& vort_Y_coarse = i_Y_coarse->get_vort();
    const SphereData& div_Y_coarse  = i_Y_coarse->get_div();
  
    SphereData& phi_Y_fine  = io_Y_fine->get_phi();
    SphereData& vort_Y_fine = io_Y_fine->get_vort();
    SphereData& div_Y_fine  = io_Y_fine->get_div();
