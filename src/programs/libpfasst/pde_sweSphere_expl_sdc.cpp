 ...
 *
 * MULE_COMPILE_FILES_AND_DIRS: src/programs/libpfasst/pde_sweSphere_expl_sdc/
...
#include "pde_sweSphere_expl_sdc/SphereDataCtxSDC.hpp"
...
int main(int i_argc, char *i_argv[])
{
    ...
    /*if (shackBenchmarks->benchmark_name == "flow_over_mountain")
    {
        ...
        shackBenchmarks->h_topography = sweet::SphereData_Physical(&(levelSingleton.sphereDataConfig));
