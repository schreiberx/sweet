...
void SWE_Sphere_TS_na_sl_vd::run_timestep_pert_1st_order(
...
void SWE_Sphere_TS_na_sl_vd::run_timestep_pert_2nd_order(
...
void SWE_Sphere_TS_na_sl_vd::run_timestep_pert(
		SphereData_Spectral &io_phi_pert,	///< prognostic variables
		SphereData_Spectral &io_vort,	///< prognostic variables
		SphereData_Spectral &io_div,	///< prognostic variables
...
void SWE_Sphere_TS_na_sl_vd::setup(
...
SWE_Sphere_TS_na_sl_vd::SWE_Sphere_TS_na_sl_vd(SimulationVariables &i_simVars, SphereOperators_SphereData &i_op) :
...
SWE_Sphere_TS_na_sl_vd::~SWE_Sphere_TS_na_sl_vd()
{
}
