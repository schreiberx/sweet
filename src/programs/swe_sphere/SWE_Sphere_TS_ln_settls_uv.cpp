...
void SWE_Sphere_TS_ln_settls_uv::run_timestep_pert(
...
void SWE_Sphere_TS_ln_settls_uv::interpolate_departure_point(
...
)
{
	...
	if (original_linear_operator_sl_treatment)
	{
		 ...
		 */
		swe_sphere_ts_ln_erk_split_uv->euler_timestep_update_pert_lg(
				U_phi, U_vrt, U_div,
