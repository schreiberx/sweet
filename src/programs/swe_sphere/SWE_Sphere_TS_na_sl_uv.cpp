...
void SWE_Sphere_TS_na_sl_uv::run_timestep_pert_1st_order(
...
void SWE_Sphere_TS_na_sl_uv::run_timestep_pert_2nd_order(
...
void SWE_Sphere_TS_na_sl_uv::run_timestep_pert(
		SphereData_Spectral &io_phi_pert,	///< prognostic variables
		SphereData_Spectral &io_vort,	///< prognostic variables
		SphereData_Spectral &io_div,	///< prognostic variables
...
void SWE_Sphere_TS_na_sl_uv::setup(
...
SWE_Sphere_TS_na_sl_uv::SWE_Sphere_TS_na_sl_uv(SimulationVariables &i_simVars, SphereOperators_SphereData &i_op) :
...
SWE_Sphere_TS_na_sl_uv::~SWE_Sphere_TS_na_sl_uv()
{
}
