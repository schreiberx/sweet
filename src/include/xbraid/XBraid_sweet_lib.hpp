...
public:
	...
	sweet_BraidVector* xbraid_data_ref_exact = nullptr;
	sweet_BraidVector* xbraid_data_fine_exact = nullptr;
		...
		if(level == 0)
		{
			...
			if (simVars->xbraid.xbraid_load_ref_csv_files)
				this->store_parareal_error(
								U->data,
								this->xbraid_data_ref_exact->data,
								N,
								iter /* + 1 */,
								it,
								t,
			...
			if (simVars->xbraid.xbraid_load_fine_csv_files)
				this->store_parareal_error(
								U->data,
								this->xbraid_data_fine_exact->data,
								N,
								iter /* + 1 */,
								it,
								t,
