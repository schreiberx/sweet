...
#ifndef SRC_INCLUDE_SWEET_SPHERE__ARCHIVE_SPHERESTAGGERING_HPP_
#define SRC_INCLUDE_SWEET_SPHERE__ARCHIVE_SPHERESTAGGERING_HPP_
...
#endif /* SRC_INCLUDE_SWEET_SPHERE__ARCHIVE_SPHERESTAGGERING_HPP_ */
