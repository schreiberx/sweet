...
public:
	...
	)
	{
		...
		// energy
		PlaneData_Spectral pot_energy = (i_prog_h+ io_simVars.sim.h0)*(io_simVars.sim.gravitation*normalization);
		PlaneData_Spectral kin_energy = (i_prog_h+ io_simVars.sim.h0)*(i_prog_u*i_prog_u+i_prog_v*i_prog_v)*(0.5*normalization);
...
public:
	...
	)
	{
		...
		// energy
		PlaneData_Spectral pot_energy = (i_prog_h+ io_simVars.sim.h0)*(io_simVars.sim.gravitation*normalization);
		PlaneData_Spectral kin_energy = (i_prog_h+ io_simVars.sim.h0)*(u*u+v*v)*(0.5*normalization);
