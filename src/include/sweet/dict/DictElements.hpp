...
public:
	...
	sweet::DictArrayND<1,double> _valueArray1dFloat64;

	void get(sweet::DictArrayND<1,float64> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<1,float64> &i_value)
	{
	...
	sweet::DictArrayND<2,double> _valueArray2dFloat64;

	void get(sweet::DictArrayND<2,float64> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<2,float64> &i_value)
	{
	...
	sweet::DictArrayND<3,double> _valueArray3dFloat64;

	void get(sweet::DictArrayND<3,float64> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<3,float64> &i_value)
	{
	...
	sweet::DictArrayND<1,complex128> _valueArray1dComplex128;

	void get(sweet::DictArrayND<1,complex128> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<1,complex128> &i_value)
	{
	...
	sweet::DictArrayND<2,complex128> _valueArray2dComplex128;

	void get(sweet::DictArrayND<2,complex128> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<2,complex128> &i_value)
	{
	...
	sweet::DictArrayND<3,complex128> _valueArray3dComplex128;

	void get(sweet::DictArrayND<3,complex128> &o_value)	const
	{
	...
	void set(const std::string &i_key, const sweet::DictArrayND<3,complex128> &i_value)
	{
	...
	)
	{
		...
		switch(type_id)
		{
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_1D_FLOAT64:
			{
				...
				sweet::DictArrayND<1, float64> array(shape);
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_2D_FLOAT64:
			{
				...
				sweet::DictArrayND<2, float64> array(shape);
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_3D_FLOAT64:
			{
				...
				sweet::DictArrayND<3, float64> array(shape);
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_1D_COMPLEX128:
			{
				std::array<int,1> shape;
				shape[0] = io_f.loadData<int64>();
				sweet::DictArrayND<1, complex128> array(shape);
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_2D_COMPLEX128:
			{
				...
				shape[0] = io_f.loadData<int64>();
				shape[1] = io_f.loadData<int64>();
				sweet::DictArrayND<2, complex128> array(shape);
			...
			case _DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_3D_COMPLEX128:
			{
				...
				shape[1] = io_f.loadData<int64>();
				shape[2] = io_f.loadData<int64>();
				sweet::DictArrayND<3, complex128> array(shape);
