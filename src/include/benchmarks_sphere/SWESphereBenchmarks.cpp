...
#include <benchmarks_sphere/SWESphereBenchmark_gaussian_bumps_test_cases.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_galewsky.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_gaussian_bump.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_gaussian_bumps_pvd.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_nair_lauritzen_sl.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_three_gaussian_bumps.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_1_advection_cos_bell.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_1_advection_gauss_bump.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_2_geostrophic_balance.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_2_geostrophic_balance_linear.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_5_flow_over_mountain.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_williamson_6_rossby_haurwitz_wave.hpp>
#include <benchmarks_sphere/SWESphereBenchmark_zero.hpp>
#include "SWESphereBenchmarks.hpp"




void SWESphereBenchmarks::setup(
...
void SWESphereBenchmarks::reset()
{
	delete master;
	master = nullptr;
...
void SWESphereBenchmarks::benchmarks_register_all()
{
	...
	registered_benchmarks.push_back(static_cast<SWESphereBenchmarks_interface*>(new SWESphereBenchmark_nair_lauritzen_sl));
	...
	registered_benchmarks.push_back(static_cast<SWESphereBenchmarks_interface*>(new SWESphereBenchmark_zero));
}



void SWESphereBenchmarks::benchmarks_free_all(SWESphereBenchmarks_interface *skip_this)
{
	for (std::size_t i = 0; i < registered_benchmarks.size(); i++)
	{
		SWESphereBenchmarks_interface *ts = registered_benchmarks[i];
...
SWESphereBenchmarks::SWESphereBenchmarks()	:
	simVars(nullptr),
	op(nullptr)
{
}
...
void SWESphereBenchmarks::printAvailableBenchmarks()
{
	benchmarks_register_all();
	for (std::size_t i = 0; i < registered_benchmarks.size(); i++)
	{
