...
public:
	...
	)
	{
		...
		o_eval[0] = (1.0L/6.0L)*((2*a00 + 2*a11 + 2*a22 - pow(2, 2.0L/3.0L)* cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) \
				...
				+ sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 \
				...
				+ sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 \
				- 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21));
	    o_eval[1] = (1.0L/12.0L)*((1 - sqrt(3)*I)*(4*a00 + 4*a11 + 4*a22 + pow(2, 2.0L/3.0L)*(1 - sqrt(3)*I)*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)))*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)) + 8*cbrt(2)*(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2)))/((1 - sqrt(3)*I)*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)));
		o_eval[2] = (1.0L/12.0L)*((1 + sqrt(3)*I)*(4*a00 + 4*a11 + 4*a22 + pow(2, 2.0L/3.0L)*(1 + sqrt(3)*I)*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)))*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)) + 8*cbrt(2)*(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2)))/((1 + sqrt(3)*I)*cbrt(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 + sqrt(-4*pow(-3*a00*a11 - 3*a00*a22 + 3*a01*a10 + 3*a02*a20 - 3*a11*a22 + 3*a12*a21 + pow(a00 + a11 + a22, 2), 3) + pow(-27*a00*a11*a22 + 27*a00*a12*a21 + 27*a01*a10*a22 - 27*a01*a12*a20 - 27*a02*a10*a21 + 27*a02*a11*a20 - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21), 2)) - 2*pow(a00 + a11 + a22, 3) + 9*(a00 + a11 + a22)*(a00*a11 + a00*a22 - a01*a10 - a02*a20 + a11*a22 - a12*a21)));
