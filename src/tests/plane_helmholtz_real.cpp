...
//		double eps_conv = 1e-3*tolerance_increase;
		 ...
		 */
		sweet::PlaneData_Spectral u_ana(planeDataConfig);
		sweet::PlaneData_Spectral v_ana(planeDataConfig);
		sweet::PlaneData_Spectral f(planeDataConfig);
		sweet::PlaneData_Spectral g(planeDataConfig);

		sweet::PlaneData_Physical u_ana_phys(planeDataConfig);
		sweet::PlaneData_Physical v_ana_phys(planeDataConfig);
		sweet::PlaneData_Physical f_phys(planeDataConfig);
		sweet::PlaneData_Physical g_phys(planeDataConfig);
		/**
		 ...
		 */
		{
			...
			sweet::PlaneData_Spectral rhs_u = u_ana;
			sweet::PlaneData_Spectral rhs_v = v_ana;
			rhs_u = op.diff_c_x(rhs_u)+op.diff_c_y(rhs_u);
			rhs_u += f;
			rhs_v = op.diff_c_x(rhs_v)+op.diff_c_y(rhs_v);
			rhs_v += g;
			sweet::PlaneData_Spectral lhs = (-(op.diff2_c_x + op.diff2_c_y)).spectral_addScalarAll(1.0);
