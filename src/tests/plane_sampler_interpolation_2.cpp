...
// Plane data config
sweet::PlaneDataConfig planeDataConfigInstance3;
sweet::PlaneDataConfig *planeDataConfig3 = &planeDataConfigInstance3;
...
)
{
	...
	for (; res_x <= max_res && res_y <= max_res; res_x *= 2, res_y *= 2)
	{
		...
		sweet::PlaneData_Spectral prog_h3_pert(planeDataConfig3);

		//PlaneData prog_test3(planeDataConfig3);
		{
			sweet::PlaneData_Spectral prog_u3(planeDataConfig3);
			sweet::PlaneData_Spectral prog_v3(planeDataConfig3);

			sweet::PlaneOperators op3(planeDataConfig3, simVars.sim.plane_domain_size);
...

		{
			...
			sweet::PlaneOperators op(planeDataConfig, simVars.sim.plane_domain_size);
			SWEPlaneBenchmarksCombined b;
		 ...
		 */
		sweet::PlaneData_Physical px(planeDataConfig3);
		sweet::PlaneData_Physical py(planeDataConfig3);
...

		{
			 ...
			 */
			sweet::PlaneData_Physical prog_h3_bilinear(planeDataConfig3);
...

		{
			 ...
			 */
			sweet::PlaneData_Physical prog_h3_bicubic(planeDataConfig3);
