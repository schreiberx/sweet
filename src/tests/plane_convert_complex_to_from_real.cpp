...
public:
	...
	{
		sweet::PlaneData_Physical test(planeDataConfig);
		sweet::PlaneData_PhysicalComplex testcplx(planeDataConfig);
		sweet::PlaneData_Spectral test_spc(planeDataConfig);
		sweet::PlaneData_SpectralComplex test_spc_cplx(planeDataConfig);
		...
		for (std::size_t y = 0; y < planeDataConfig->physical_data_size[1]; y++)
		{
			for (std::size_t x = 0; x < planeDataConfig->physical_data_size[0]; x++)
			{
				...
				sweet::PlaneData_Physical tmp = Convert_PlaneDataPhysicalComplex_To_PlaneDataPhysical::physical_convert_real(testcplx);
	...
	{
		sweet::PlaneData_Spectral test(planeDataConfig);
		sweet::PlaneData_SpectralComplex testcplx(planeDataConfig);
		sweet::PlaneData_Physical test_phys(planeDataConfig);
		sweet::PlaneData_PhysicalComplex test_phys_cplx(planeDataConfig);
		...
		for (std::size_t y = 0; y < planeDataConfig->physical_data_size[1]; y++)
		{
			for (std::size_t x = 0; x < planeDataConfig->physical_data_size[0]; x++)
			{
				...
				//sweet::PlaneData_Spectral tmp = Convert_PlaneDataSpectralComplex_To_PlaneDataSpectral::physical_convert_real(testcplx);
				sweet::PlaneData_Spectral tmp = Convert_PlaneDataSpectralComplex_To_PlaneDataSpectral::spectral_convert_physical_real_only(testcplx);
		...
		for (std::size_t y = 0; y < planeDataConfig->spectral_data_size[1]; y++)
		{
			for (std::size_t x = 0; x < planeDataConfig->spectral_data_size[0]; x++)
			{
...

				{
					...
					sweet::PlaneData_Spectral tmp = Convert_PlaneDataSpectralComplex_To_PlaneDataSpectral::spectral_convert_physical_real_only(testcplx);
					//sweet::PlaneData_Spectral tmp = Convert_PlaneDataSpectralComplex_To_PlaneDataSpectral::physical_convert_imag(testcplx);
