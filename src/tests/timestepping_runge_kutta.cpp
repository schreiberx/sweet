...
public:
	...
	{
		sweet::PlaneData_Physical o_h_t_phys(planeDataConfig);
		sweet::PlaneData_Physical o_u_t_phys(planeDataConfig);
		sweet::PlaneData_Physical o_v_t_phys(planeDataConfig);
	...
	for (int fun_order = 0; fun_order <= 4; fun_order++)
	{
		...
		for (int ts_order = 1; ts_order <= 4; ts_order++)
		{
			...
			while(true)
			{
				...
				{
					sweet::PlaneData_Physical benchmark_h_phys(planeDataConfig);
