...
{
public:
	sweet::PlaneData_Spectral prog_h_pert, prog_u, prog_v;

	// Initial values for comparison with analytical solution
	sweet::PlaneData_Spectral t0_prog_h_pert, t0_prog_u, t0_prog_v;

	// Forcings
	sweet::PlaneData_Spectral force_h_pert, force_u, force_v;
...
#if SWEET_GUI
	sweet::PlaneData_Spectral viz_plane_data;
...
public:
	...
	void reset()
	{
		...
		sweet::PlaneData_Physical prog_h_pert_phys(planeDataConfig);
