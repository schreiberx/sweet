...
public:
	...
	sweet::PlaneData_Spectral hu;
	sweet::PlaneData_Spectral hv;
...
public:
	SimulationAdvection(sweet::PlaneDataConfig *i_planeDataConfig)	:
	...
	sweet::PlaneData_Spectral get_advected_solution(
		double i_timestamp
	)
	{
		sweet::PlaneData_Spectral ret_h(planeDataConfig);
		sweet::PlaneData_Physical ret_h_phys(planeDataConfig);
	...
	sweet::PlaneData_Spectral get_advected_solution_diffx(
		double i_timestamp
	)
	{
		sweet::PlaneData_Spectral ret_h(planeDataConfig);
	...
	sweet::PlaneData_Spectral get_advected_solution_diffy(
		double i_timestamp
	)
	{
		sweet::PlaneData_Spectral ret_h(planeDataConfig);
	...
	void reset()
	{
		...
		sweet::PlaneData_Physical prog_u_phys(planeDataConfig);
		sweet::PlaneData_Physical prog_v_phys(planeDataConfig);
	...
	)
	{
		...
		{
			sweet::PlaneData_Physical o_h_t_phys = o_h_t.toPhys();
			sweet::PlaneData_Physical i_h_phys = i_h.toPhys();
		...
		else if (_shackProgramSpecific.advection_scheme == 1)
		{
			...
			sweet::PlaneData_Spectral avg_b_x_spec(o_h_t.planeDataConfig);
			sweet::PlaneData_Spectral avg_b_y_spec(o_h_t.planeDataConfig);
	...
	)
	{
		...
		default:
		{
			sweet::PlaneData_Physical prog_h_phys = prog_h.toPhys();
		...
		case 1:
		{
			...
			sweet::PlaneData_Physical tmp_phys = tmp.toPhys();
...
{
	sweet::PlaneData_Spectral benchmark_h = simulationAdvection->get_advected_solution(_simVars.timecontrol.current_simulation_time);
