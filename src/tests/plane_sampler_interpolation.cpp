...
sweet::PlaneDataConfig planeDataConfigOversamplingInstance;
sweet::PlaneDataConfig *planeDataConfigOversampling = &planeDataConfigOversamplingInstance;
...
public:
	...
	void reset()
	{
		...
		sweet::PlaneData_Physical prog_h_phys(prog_h.planeDataConfig);
