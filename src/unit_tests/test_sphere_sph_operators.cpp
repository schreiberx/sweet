...
void run_tests()
{
	...
	if (true)
	{
		...
		for (int i = 0; i < 3; i++)
		{
...
#if 0
			{
				...
				SphereDataErrorCheck::check(lhs, zero, "div freeness NON-Robert formulation", error_threshold, true /* Ignored, because NON-Robert */);
			}

			{
				...
				SphereDataErrorCheck::check(lhs, rhs, "DIV(U*phi) NON-Robert", error_threshold, true /* Ignored, because NON-Robert */);
			}
#endif
		}
	}
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(h, one, "mu^2 * 1.0/(1-mu^2)", error_threshold, false, true);
	}
#endif
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(h, one, "1.0/(1-mu^2) ver2", error_threshold, false, true);
	}
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(lhs, zero, "TEST div(u,v)=0 with non-Robert formulation", error_threshold);
	}
#endif
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(lhs, rhs, "TEST diff_lon(phi)", error_threshold*1e1);
#endif
	}
#endif
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(lhs, rhs, "TEST div_i(phi) with NON Robert formulation", error_threshold);
	}
#endif
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(lhs, rhs, "TEST div_i(phi) with Robert formulation", error_threshold);
	}
...
//		double theta_c = 0;
	...
	if (true)
	{
		...
		SphereDataErrorCheck::check(h, result, "ROBERT DIV LONGITUDE", error_threshold*1e2);
	}
#endif
...

	{
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(data, data2, "operator*123.0");
		}
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(data, data2, "operator+(double)");
		}
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, hphi, " vs. MU");
		}
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "TEST DIFF LAT MU", error_threshold*1e2, false, true);
		}
#endif
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "TEST mu*()");
		}
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "TEST mu*mu*()");
		}
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "TEST (1-mu*mu)*d/dmu");
		}
#endif
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "TEST GRAD LON");
		}
#endif
		...
		if (true)
		{
			...
			SphereDataErrorCheck::check(h, result, "LAT");
		}
