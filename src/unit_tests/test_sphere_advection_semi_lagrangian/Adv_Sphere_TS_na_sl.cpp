...
)
{
	...
	semiLagrangian.semi_lag_departure_points_settls(
			diag_u_prev*(dt/simVars.sim.sphere_radius), diag_v_prev*(dt/simVars.sim.sphere_radius),
			diag_u*(dt/simVars.sim.sphere_radius), diag_v*(dt/simVars.sim.sphere_radius),
			posx_a, posy_a,
			posx_d, posy_d,
