...
cd "/home/martin/workspace/sweet/benchmarks_sphere/rossby_haurwitz_wave/script_ln2_g9.81_h10000_f7.2921e-05_a6371220_fsph0_u0.0_U0_tsm_lg_irk_lc_n_erk_ver1_tso2_tsob2_C000240_M0128_MPI_space01_time001"
...
SWEETROOT="/home/martin/workspace/sweet/benchmarks_sphere/rossby_haurwitz_wave/script_ln2_g9.81_h10000_f7.2921e-05_a6371220_fsph0_u0.0_U0_tsm_lg_irk_lc_n_erk_ver1_tso2_tsob2_C000240_M0128_MPI_space01_time001/../../../"
cd "$SWEETROOT"
...
EXEC="$SWEETROOT/build/swe_sphere_spspec_spdeal_quadmath_numa2_fft_gnu_release  -g 9.81 -H 10000 -f 7.2921e-05 -F 0 -a 6371220 -M 128 --pde-id 0 --staggering=0 -S 1 -X 1 -Y 1 -s 4 --benchmark=rossby_haurwitz_wave -v 2 --dt=240 -o 3600 -u 0.0 -t 3600 --stability-checks=0 --use-linear-div=0 --timestepping-method=lg_irk_lc_n_erk_ver1 --timestepping-order=2 --timestepping-order2=2 --normal-mode-analysis-generation=0 --rexi-method= --polvani-rossby=-1.0 --polvani-froude=-1.0 --use-robert-functions=1 --compute-error=0"
