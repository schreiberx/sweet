...
#		p.cluster.pm_time_cores_per_mpi_rank = 1
		...
		for tsm in ts_methods[1:]:
			...
			for (	
					...
					p.runtime.benchmark_galewsky_umax,
					p.runtime.benchmark_galewsky_hamp,
					p.runtime.benchmark_galewsky_phi2
				) in itertools.product(
					samples_coriolis_omega,
					samples_gravitation,
					samples_h0,
					#samples_earth_radius,
					#samples_viscosity,
					#samples_mode_res,
					#samples_timestep_size,

					samples_galewsky_umax,
					samples_galewsky_hamp,
					samples_galewsky_phi2
				):
					print(p.runtime.f)
					print(p.runtime.g)
					print(p.runtime.h)
					print(p.runtime.r)
					print(p.runtime.viscosity)
					print(p.runtime.mode_res)
					print(p.runtime.timestep_size)

					print(p.runtime.benchmark_galewsky_umax)
					print(p.runtime.benchmark_galewsky_hamp)
					print(p.runtime.benchmark_galewsky_phi2)
