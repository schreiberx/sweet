...
#	plt.yscale("log", nonposy='clip')
	...
	for comp_file in comp_files:
		...
		tmp = tmp.replace('script_g1_h100000_f0.000145842_a6371220_u0_robert1_pdeid1', '')
		tmp = tmp.replace('script_g1_h100000_f0.000145842_a6371220_u0_robert1_pdeid1', '')
		tmp = tmp.replace('_fsphere0', '')
		tmp = tmp.replace('_fsphere1', '')
		...
		tmp = tmp.replace('_tsob1_C000400_T001_M0016', '_m')
