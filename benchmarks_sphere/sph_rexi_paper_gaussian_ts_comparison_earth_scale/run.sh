...
STDEXEC="$SWEETDIR/build/swe_sphere_rexi_spherespectral_spheredealiasing_omp_libfft_gnu_release -M 128 -s 9 --nonlinear=0 -o $OUTPUT_TIME -t $SIMTIME --rexi-sphere-preallocation 0 --use-robert-functions=1 -F 0"
