...
for i in range(0, len(files)):
	...
	# RK2
	f = f.replace('script_modes064_bench11_nonlin0_g-1_h-1_f-1_a-1_u0_pdeid1_tsm1_tso2_rexim00000_rexih0.15_rexinorm0_rexihalf0_rexiextmodes00_rexipar1_C00000100_t00001000_o00000100_robert1.err', 'Runge-Kutta order 2')

	f = f.replace('script_modes064_bench11_nonlin0_g-1_h-1_f-1_a-1_u0_pdeid1_', '')
	...
	f = f.replace('_rexiextmodes02_rexipar1_C00000100_t00001000_o00000100_robert1', '')
	f = f.replace('.err', '')
