...
jg.runtime.xbraid_viscosity_order = 2;                                        ## viscosity coefficient
jg.runtime.xbraid_viscosity_coefficient = str(jg.runtime.viscosity) + ",1e6"; ## viscosity fine,coarse
...
for (nb_levels, cfactor, nrelax, tsm, spatial_coarsening) in product(nbs_levels, cfactors, nrelaxs, tsms, spatial_coarsenings):
