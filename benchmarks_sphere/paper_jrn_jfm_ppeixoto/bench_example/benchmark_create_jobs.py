...
jg.runtime.max_simulation_time = 60*60*24*30   # (in seconds) 1 year
...
jg.runtime.output_timestep_size = jg.runtime.max_simulation_time/30
...
if __name__ == "__main__":
    ...
    n_list = [5, 3, 7]
    m_list = [4, 1, 3]
    experiment = mexp.modes_TC2(n_list, m_list, alpha_min, alpha_max, alpha_samples) 
