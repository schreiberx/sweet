...
cd "/home/martin/workspace/sweet/benchmarks_sphere/paper_sph-rexi-nonlinear_compare_T_and_WT_vs_accuracy_galewsky_coolmuc/script_ln2g9.81_h10000_f7.2921e-05_a6371220_fsph0_u0.0_U0_tsm_lg_irk_lc_n_erk_ver0_tso2_tsob2_C000720_M0128_MPI_space002_time001"
...
EXEC="/home/martin/workspace/sweet/build/swe_sphere_spspec_spdeal_quadmath_mpi_rxtime_numa2_fft_gnu_release  -g 9.81 -H 10000 -f 7.2921e-05 -F 0 -a 6371220 -M 128 --pde-id 0 --staggering=0 -S 1 -X 1 -Y 1 -s 4 --benchmark= -v 0 --dt=720 -o 432000 -u 0.0 -t 432000 --stability-checks=1 --use-linear-div=0 --use-local-visc=0 --timestepping-method=lg_irk_lc_n_erk_ver0 --timestepping-order=2 --timestepping-order2=2 --normal-mode-analysis-generation=0 --rexi-method= --polvani-rossby=-1.0 --polvani-froude=-1.0 --use-robert-functions=1 --compute-error=0 --shtns-use-plans=1"
echo "$EXEC"
$EXEC
