...
if len(sys.argv) > 1:
	...
	output_filename = "./postprocessing_h_plot_err_vs_simtime.pdf"
...
#	prev_name = prev_name.replace('C129600_', '')
	...
	prev_name = prev_name.replace('REXITER_', '')
	prev_name = prev_name.replace('_m0', '_m')
	prev_name = prev_name.replace('_m0', '_m')
	prev_name = prev_name.replace('_m0', '_m')
	prev_name = prev_name.replace('_m0', '_m')
	...
	if mode == 'simtime':
		...
		#print("LKJASLDFKJALSKJDFASDFLKAJSDFLJKASDFJ")
		#sys.exit(1)
