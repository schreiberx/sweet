...
if __name__ == "__main__":
    ...
    ts_methods = [
        ['ln_erk',        4,    4,    0],
        #['l_n_erk_split_vd',        4,    4,    0],

        ###########
        # Runge-Kutta
        ###########
        ['ln_erk_split_aa_vd',     2,    2,    0],
        ['ln_erk_split_vd',        2,    2,    0],


        ###########
        # SETTLS variants
        ###########
        ['l_irk_na_sl_nr_settls_vd_only',    2,    2,    0],
        ...
        # EXP variants
        ###########
        ['lg_exp_na_sl_lc_nr_settls_ver0_vd', 2, 2, 0],
        ['lg_exp_na_sl_lc_nr_settls_ver1_vd', 2, 2, 0],
    ]
