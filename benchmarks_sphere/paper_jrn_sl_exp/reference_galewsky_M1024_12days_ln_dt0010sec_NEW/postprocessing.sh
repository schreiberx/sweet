...
#JOB_DIR=job_benchref_RT_u0.0_tsm_ln_erk_tso4_tsob4_dt00005.00_W-00001
...
for i in spectrum_kinetic_energy; do # spectrum_phi_pert spectrum_vrt spectrum_div output_prog_h_pert output_prog_vrt output_prog_div; do
