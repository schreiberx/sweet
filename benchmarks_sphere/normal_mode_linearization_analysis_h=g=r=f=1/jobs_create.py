...
#		content += ' -O -'	# deactivate file output
		...
		content += ' --use-coriolis-formulation='+str(self.use_coriolis_formulation)
...
"""
	...
	def create_job_id(self):
		...
		idstr += '_corio'+str(1 if self.use_coriolis_formulation else 0)
...
for p.pde_id in [0, 1]:
	...
	for p.use_coriolis_formulation in [0, 1]:
