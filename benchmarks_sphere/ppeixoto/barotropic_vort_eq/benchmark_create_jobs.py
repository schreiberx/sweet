...
jg.runtime.max_simulation_time = 60*60*12    # 1 hour

#params_timestep_sizes_explicit = [30]
#params_timestep_sizes_explicit = [15/8, 15/4, 15/2, 15, 30, 60, 120, 180, 360]
#params_timestep_sizes_explicit = [15/2, 15, 30, 60, 120, 180, 360]
params_timestep_sizes_explicit = [15]

#params_timestep_sizes_implicit = [30]
#params_timestep_sizes_implicit = [15/8, 15/4, 15/2, 15, 30, 60, 120, 180, 360, 480, 600, 720, 960]
#params_timestep_sizes_implicit = [15/2, 15, 30, 60, 120, 180, 360, 480, 600, 720]
params_timestep_sizes_implicit = [15]

#params_timestep_sizes_exp = [30]
#params_timestep_sizes_exp = [15, 30, 60, 120, 180, 240, 300, 360, 480, 600, 720, 960]
#params_timestep_sizes_exp = [15, 30, 60, 120, 180, 240, 300, 360, 480]
params_timestep_sizes_exp = [15]
