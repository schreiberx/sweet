...
#mpi_ranks = [1, 2, 4, 8, 14, 28, 28*2, 28*4, 28*8, 28*32, 28*128]
mpi_ranks = [i*14 for i in range(1, 4096*2)]


# Maximum of total threads (MPI ranks x threads)
#max_total_threads = 4*1024
#max_total_threads = 4096
max_total_threads = 4300
...
while m < 2000:
	M_list.append(m)
	m *= 2;
#M_list = [64, 92, 128, 256, 512] #, 1024, 2048, 2048*4, 2048*8, 2048*16, 2048*32, 2048*64]
M_list = [512] #, 1024, 2048, 2048*4, 2048*8, 2048*16, 2048*32, 2048*64]
