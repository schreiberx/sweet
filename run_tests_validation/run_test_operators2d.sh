...
EXEC="./build/test_operators2d_*_release -N 16 -S 1 --timestepping-method=ln_erk --timestepping-order 4"
echo "$EXEC"
$EXEC || exit
...
echo "***********************************************"
EXEC="./build/test_operators2d_*_release -N 16 -S 0 --timestepping-method=ln_erk --timestepping-order 4"
echo "$EXEC"
$EXEC || exit
