...
echo "***********************************************"
make clean
scons --threading=omp --unit-test=test_runge_kutta --gui=disable --plane-spectral-space=disable --libfft=disable --mode=release --plane-spectral-dealiasing=disable || exit 1
