...
./build/test_samplers_planespectral_libfft_omp_gnu_release -s 2 -n 128 -m 128 || exit
./build/test_samplers_planespectral_libfft_omp_gnu_release -s 3 -n 128 -m 128 || exit
