...
"""
		...
		for i in override_list:
			if 'Job_'+i in os.environ:
				#print("INFO: Overriding environment variable "+i+"="+os.environ['Job_'+i])
				content += "export "+i+"="+os.environ['Job_'+i]+"\n"
...
"""
	...
	def get_jobscript_directory(self, i_job_dirpath = None):
		"""
	...
	def gen_jobscript_directory(self, i_job_dirpath = None):
		...
		i_job_dirpath = self.get_jobscript_directory(i_job_dirpath)
