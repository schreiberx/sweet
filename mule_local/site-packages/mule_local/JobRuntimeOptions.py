...
class JobRuntimeOptions(InfoError):
    ...
    def __init__(self, dummy_init = False):
        ...
        self.semi_lagrangian_iterations = None
        ...
        if not 'runtime.timestepping' in filter_list:
            if self.timestepping_method != None:
                ...
                if not 'runtime.semi_lagrangian' in filter_list:
                    if self.semi_lagrangian_iterations != None:
                        idstr += '_sli'+str(self.semi_lagrangian_iterations)
    ...
    def getRuntimeOptions(self):
        ...
        if self.semi_lagrangian_iterations != None:
            retval += ' --semi-lagrangian-iterations='+str(self.semi_lagrangian_iterations)
        ...
        if self.rexi_method != '' and self.rexi_method != 'direct':
            ...
            if self.rexi_method == 'file':
                ...
                if self.p_job_dirpath == None:
                    raise Exception("self.p_jb_dirpath not set!")
