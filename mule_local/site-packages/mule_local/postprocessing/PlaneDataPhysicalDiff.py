...
class PlaneDataPhysicalDiff(InfoError):
	...
	def compute_diff(
		...
		if size_ref_j == size_cmp_j and size_ref_i == size_cmp_i:
...
if __name__ == "__main__":
	if len(sys.argv) <= 3:
		print("")
		print("Usage:")
		print("	"+sys.argv[0]+" [infile A] [infile B] [picklefile output file (optional)] [reference tagname (optional)]")
		print("")
		print("	infile A:")
	...
	s.compute_diff(filename_a, filename_b, sys.argv[3:])
	s.print()
