...
class ELREXI:
	...
	def setup(
		...
		self.unique_id_string = ""
		self.unique_id_string += "_"+self.function_name
		self.unique_id_string += "_"+str(self.N)
		self.unique_id_string += "_"+str(self.efloat.re(lambda_max_imag))
		self.unique_id_string += "_"+str(self.efloat.re(lambda_max_real))
