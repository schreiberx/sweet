...
plt.imshow(udata, interpolation='nearest', origin='lower', aspect='auto', cmap=plt.get_cmap('jet'))
plt.savefig('udata.eps', dpi=300, transparent=True, bbox_inches='tight', pad_inches=0)

plt.figure(2, figsize=figsize)
plt.imshow(vdata, interpolation='nearest', origin='lower', aspect='auto', cmap=plt.get_cmap('jet'))
plt.savefig('vdata.eps', dpi=300, transparent=True, bbox_inches='tight', pad_inches=0)


print(udata)
print(vdata)

uspec=np.fft.fft2(udata)
vspec=np.fft.fft2(vdata)

plt.figure(3, figsize=figsize)
plt.imshow(abs(uspec), interpolation='nearest', origin='lower', aspect='auto', cmap=plt.get_cmap('jet'))
plt.savefig('uspec.eps', dpi=300, transparent=True, bbox_inches='tight', pad_inches=0)

plt.figure(4, figsize=figsize)
plt.imshow(abs(vspec), interpolation='nearest', origin='lower', aspect='auto', cmap=plt.get_cmap('jet'))
plt.savefig('vspec.eps', dpi=300, transparent=True, bbox_inches='tight', pad_inches=0)
