...
e^{\tau L} & \approx & \sum_{n=-N}^{N}Re\left(\beta_{n}^{Re}(\tau\Sigma\Lambda\Sigma^{H}+\alpha_{n}I)^{-1}\right)\nonumber \\
 ...
 & = & \sum_{n=-N}^{N}Re\left(\beta_{n}^{Re}\Sigma(\tau\Lambda+\alpha_{n})^{-1}\Sigma^{H}\right)TODO:\,is\,this\,correct?\nonumber \\
 & = & \Sigma\left[\sum_{n=-N}^{N}Re\left(\beta_{n}^{Re}(\tau\Lambda+\alpha_{n})^{-1}\right)\right]\Sigma^{H}\nonumber \\
 & \approx & \Sigma e^{\tau\Lambda}\Sigma^{H}\label{eq:expLeigen}
\end{eqnarray}
