...
v&=& \frac{2 g \pi}{f_0 L_x} \sin(2\pi x/L_x) \sin(2\pi y/L_y)\\
\end{eqnarray}
with forcings
\begin{eqnarray}
f_h&=&\cos(2 \pi x/L_x)\sin(2\pi y /L_y) + \bar{\eta}\\
f_u&=&-\frac{2g \pi}{f_0 L_y} \cos(2\pi x/L_x) \cos(2\pi /L_y)\\
f_v&=& \frac{2g \pi}{f_0 L_x} \sin(2\pi x/L_x) \sin(2\pi /L_y)\\
\end{eqnarray}
