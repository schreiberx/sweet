...
subprocess.call('scons --program=swe_rexi --plane-spectral-space=enable --plane-spectral-dealiasing=disable --libfft=enable --threading=off --rexi-parallel-sum=enable --mode=release '.split(' '), shell=False)

binary = './build/swe_rexi_planespectral_libfft_rexipar_gnu_release'
