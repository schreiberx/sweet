...
if True:
	...
	while True:
		...
		elif 'specnummodes' in headerstr[2:]:
			pass
		elif 'specrealresx' in headerstr[2:]:
			pass
		elif 'specrealresy' in headerstr[2:]:
			pass
		elif 'physresx' in headerstr[2:]:
			pass
		elif 'physresy' in headerstr[2:]:
			pass
		elif 'normalmodegeneration' in headerstr[2:]:
			pass
		elif 'antialiasing' in headerstr[2:]:
			pass
