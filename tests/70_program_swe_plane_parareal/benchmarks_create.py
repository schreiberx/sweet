...
#
jg.runtime.max_simulation_time = 30.
jg.runtime.output_timestep_size = 10.
...
jg.runtime.space_res_spectral = 8
...
parareal_coarse_slices = [3];
parareal_coarse_timesteps = [5, 10, -1]
