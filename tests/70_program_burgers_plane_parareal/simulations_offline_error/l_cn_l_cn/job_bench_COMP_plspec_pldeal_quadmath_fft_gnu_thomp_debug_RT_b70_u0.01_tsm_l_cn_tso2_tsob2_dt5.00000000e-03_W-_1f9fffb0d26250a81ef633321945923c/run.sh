...
# Job id: RT_b70_u0.01_tsm_l_cn_tso2_tsob2_dt5.00000000e-03_W-00001_M0032_N-001_ptsm_l_cn_pDt_-1_pStore_1
#
...
SCONS="scons  --mode=debug --compiler=gnu --sanitize= --debug-symbols=enable --simd=enable --mic=disable --fortran-source=disable --lapack=enable --program-binary-name= --sweet-mpi=disable --threading=omp --rexi-thread-parallel-sum=disable --benchmark-timings=disable --rexi-timings-additional-barriers=disable --rexi-allreduce=disable --program=burgers --parareal=none --parareal-scalar=disable --parareal-plane=disable --parareal-sphere=disable --parareal-plane-swe=disable --parareal-plane-burgers=disable --libpfasst=disable --eigen=disable --libfft=enable --libsph=disable --mkl=disable --plane-spectral-space=enable --plane-spectral-dealiasing=enable --sphere-spectral-space=disable --sphere-spectral-dealiasing=disable --libxml=disable --gui=disable --quadmath=enable -j 4"
echo "$SCONS"
$SCONS || exit 1


# chdir to execution directory
cd "/home/jcaldass/Development/IME/sweet/tests/70_program_burgers_plane_parareal/job_bench_COMP_plspec_pldeal_quadmath_fft_gnu_thomp_debug_RT_b70_u0.01_tsm_l_cn_tso2_tsob2_dt5.00000000e-03_W-_1f9fffb0d26250a81ef633321945923c"
